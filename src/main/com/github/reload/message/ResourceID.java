...
public final class ResourceID extends RoutableID {
	...
	public static class ResourceIDCodec extends Codec<ResourceID> {
		...
		@Override
		public void encode(ResourceID obj, ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
		...
		@Override
		public ResourceID decode(ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
