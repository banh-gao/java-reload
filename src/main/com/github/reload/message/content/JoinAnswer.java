...
public class JoinAnswer extends Content {
	...
	public static class JoinAnswerCodec extends Codec<JoinAnswer> {
		...
		@Override
		public void encode(JoinAnswer obj, ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
		...
		@Override
		public JoinAnswer decode(ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
