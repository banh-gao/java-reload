...
public class ConfigUpdateRequest extends Content {
	...
	public static class ConfUpdateReqCodec extends Codec<ConfigUpdateRequest> {
		...
		@Override
		public void encode(ConfigUpdateRequest obj, ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
		...
		@Override
		public ConfigUpdateRequest decode(ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
