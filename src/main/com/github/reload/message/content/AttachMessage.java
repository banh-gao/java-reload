...
public class AttachMessage extends Content {
	...
	public static class AttachMessageCodec extends Codec<AttachMessage> {
		...
		private void encodeCandidates(AttachMessage obj, ByteBuf buf) throws com.github.reload.message.Codec.CodecException {
		...
		private List<IceCandidate> decodeCandidates(ByteBuf buf) throws com.github.reload.message.Codec.CodecException {
