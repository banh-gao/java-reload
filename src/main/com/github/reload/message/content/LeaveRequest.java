...
public class LeaveRequest extends Content {
	...
	public static class LeaveRequestCodec extends Codec<LeaveRequest> {
		...
		@Override
		public void encode(LeaveRequest obj, ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
		...
		@Override
		public LeaveRequest decode(ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
