...
public class RouteQueryAnswer extends Content {
	...
	public static class RouteQueryAnswerCodec extends Codec<RouteQueryAnswer> {
		...
		@Override
		public void encode(RouteQueryAnswer obj, ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
			buf.writeBytes(obj.overlayData);
		}

		@Override
		public RouteQueryAnswer decode(ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
