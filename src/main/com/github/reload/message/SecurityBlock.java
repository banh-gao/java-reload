...
public class SecurityBlock {
	...
	public static class SecurityBlockCodec extends Codec<SecurityBlock> {
		...
		@Override
		public void encode(SecurityBlock obj, ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
		...
		@Override
		public SecurityBlock decode(ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
