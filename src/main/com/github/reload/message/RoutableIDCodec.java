...
public class RoutableIDCodec extends Codec<RoutableID> {
	...
	@Override
	public void encode(RoutableID obj, ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
	...
	@Override
	public RoutableID decode(ByteBuf buf, Object... params) throws com.github.reload.message.Codec.CodecException {
