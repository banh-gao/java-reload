...
import com.github.reload.net.encoders.content.ConfigUpdateRequest.ConfUpdateReqCodec;
...
public class ConfigUpdateRequest extends Content {
	...
	static class ConfUpdateReqCodec extends Codec<ConfigUpdateRequest> {
		...
		@Override
		public void encode(ConfigUpdateRequest obj, ByteBuf buf, Object... params) throws com.github.reload.net.encoders.Codec.CodecException {
		...
		@Override
		public ConfigUpdateRequest decode(ByteBuf buf, Object... params) throws com.github.reload.net.encoders.Codec.CodecException {
