...
import com.github.reload.net.encoders.content.PingRequest.PingRequestCodec;
...
public class PingRequest extends Content {
	...
	static class PingRequestCodec extends Codec<PingRequest> {
		...
		@Override
		public void encode(PingRequest obj, ByteBuf buf, Object... params) throws com.github.reload.net.encoders.Codec.CodecException {
		...
		@Override
		public PingRequest decode(ByteBuf buf, Object... params) throws com.github.reload.net.encoders.Codec.CodecException {
