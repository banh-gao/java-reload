...
public class ReloadServer extends AbstractIdleService {
	...
	public ReloadServer(Components context, InetSocketAddress localAddr, OverlayLinkType linkType) {
	...
	private ChannelFuture bind(InetSocketAddress localAddr, OverlayLinkType linkType, EventLoopGroup loopGroup, Components context) {
