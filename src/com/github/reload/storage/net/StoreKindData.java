...
public class StoreKindData {
	...
	public static class StoreKindDataCodec extends Codec<StoreKindData> {
		...
		@Override
		public void encode(StoreKindData obj, ByteBuf buf, Object... params) throws com.github.reload.net.data.Codec.CodecException {
		...
		@Override
		public StoreKindData decode(ByteBuf buf, Object... params) throws com.github.reload.net.data.Codec.CodecException {
		...
		private List<StoredData> decodeStoredDataList(DataKind kind, ByteBuf buf) throws com.github.reload.net.data.Codec.CodecException {
