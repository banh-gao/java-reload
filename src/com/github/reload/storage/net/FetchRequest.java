...
public class FetchRequest extends Content {
	...
	public static class FetchRequestCodec extends Codec<FetchRequest> {
		...
		private void encodeSpecifiers(FetchRequest obj, ByteBuf buf) throws com.github.reload.net.data.Codec.CodecException {
		...
		private List<StoredDataSpecifier> decodeSpecifiers(ByteBuf buf) throws com.github.reload.net.data.Codec.CodecException {
