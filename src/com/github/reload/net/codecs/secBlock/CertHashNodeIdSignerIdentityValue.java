...
import com.github.reload.net.codecs.secBlock.CertHashNodeIdSignerIdentityValue.CertHashNodeIdSignerIdentityValueCodec;
...
public class CertHashNodeIdSignerIdentityValue extends SignerIdentityValue {
	...
	static class CertHashNodeIdSignerIdentityValueCodec extends Codec<CertHashNodeIdSignerIdentityValue> {
		...
		public CertHashNodeIdSignerIdentityValueCodec(ObjectGraph ctx) {
			super(ctx);
		}
