...
import com.github.reload.net.codecs.header.NodeID.NodeIdCodec;
...
public class NodeID extends RoutableID {
	...
	static class NodeIdCodec extends Codec<NodeID> {
		...
		public NodeIdCodec(ObjectGraph ctx) {
			super(ctx);
		}
		...
		@Override
		public NodeID decode(ByteBuf buf, Object... params) throws com.github.reload.net.codecs.Codec.CodecException {
