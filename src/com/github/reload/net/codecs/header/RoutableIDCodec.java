...
import com.github.reload.net.codecs.header.RoutableID.DestinationType;
...
class RoutableIDCodec extends Codec<RoutableID> {
	...
	public RoutableIDCodec(ObjectGraph ctx) {
		super(ctx);
	...
	@Override
	public void encode(RoutableID obj, ByteBuf buf, Object... params) throws com.github.reload.net.codecs.Codec.CodecException {
	...
	@Override
	public RoutableID decode(ByteBuf buf, Object... params) throws com.github.reload.net.codecs.Codec.CodecException {
