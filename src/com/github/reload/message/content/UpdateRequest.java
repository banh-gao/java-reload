...
public class UpdateRequest extends Content {
	...
	public static class UpdateRequestCodec extends Codec<UpdateRequest> {
		...
		@Override
		public void encode(UpdateRequest obj, ByteBuf buf, Object... params) throws com.github.reload.net.data.Codec.CodecException {
			buf.writeBytes(obj.overlayData);
		}

		@Override
		public UpdateRequest decode(ByteBuf buf, Object... params) throws com.github.reload.net.data.Codec.CodecException {
